"""
Django settings for procurements project.
...
SECRET_KEY = 'django-insecure-p@+&-s_%^*c*leggf-_eyjnjk(ma!5yxsgtx-dk6^g!qmw=!u_'
...
ROOT_URLCONF = 'procurements.urls'
...
WSGI_APPLICATION = 'procurements.wsgi.application'
